...
export const PRIMARY_WORLD_ZONES: WorldZone[] = [
  {
    ...
    emoji: '🟢',
    label: 'Piac',
    title: 'Marketplace Zóna',
    subtitle: 'Vásárlás, eladás, termékek',
    path: '/search',
    icon: ShoppingBag,
    color: '#00E676',
  ...
  },
  {
    ...
    label: 'Licit',
    title: 'Aukció Aréna',
    subtitle: 'Élő licitek, verseny, feszültség',
    path: '/auctions',
    icon: Gavel,
    color: '#A855F7',
  ...
  },
  {
    ...
    label: 'Állás',
    title: 'Állás Központ',
    subtitle: 'Állások, küldetések, karrier',
    path: '/jobs',
    icon: Briefcase,
    color: '#38BDF8',
  ...
  },
  {
    ...
    label: 'Közösség',
    title: 'Közösségi Tér',
    subtitle: 'Fórum, beszélgetés, hírek',
    path: '/forum',
    icon: Users,
    color: '#FBBF24',
  ...
  },
  {
    ...
    label: 'Üzleti',
    title: 'Üzleti Negyed',
    subtitle: 'Vállalkozások, boltok, szolgáltatások',
